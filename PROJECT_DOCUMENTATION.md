...
### 5.0 Platform User Interface & Application Screenshots

The following screenshots demonstrate the primary user-facing interfaces and responsive layouts implemented across the **Career Kuch Hatke** web platform:

#### Figure 5.1: Home Portal (`index.html`)
- **Visual Features:** "Your Dream Career Exists" hero banner, interactive "Rat Race vs. Hatke Career" problem-solution dilemma cards, domain category navigation (Creative, Tech, Science, Business, Unique), and responsive footer.
- **File Asset:** `images/screenshot-home.png`

#### Figure 5.2: Dynamic Career Roadmap Engine (`career-detail.html`)
- **Visual Features:** Single-page dynamic template (illustrated for *AI Prompt Engineer*), modular salary trajectory (Starting through Senior packages), degree safety cushion, accredited college pathways, and the 30-Second WhatsApp Parent Pitch tool.
- **File Asset:** `images/screenshot-roadmap.png`

#### Figure 5.3: About Us & Research Transparency (`about.html`)
- **Visual Features:** Developer background and academic motivation (Sneha Prajapati), statistical breakdown of student career anxiety in India, and verified 2026 data research methodology.
- **File Asset:** `images/screenshot-about.png`

#### Figure 5.4: Student Inquiries & Career Suggestions (`contact.html`)
- **Visual Features:** Interactive student feedback form supporting feedback inquiries and community career submissions with client and server-side input validation.
- **File Asset:** `images/screenshot-contact.png`

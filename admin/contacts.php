...
<div class="admin-container">
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions">
                            <?php if ($row['status'] === 'unread'): ?>
                                <a class="action-read" href="delete.php?type=mark_read&id=<?php echo $row['id']; ?>">✓ Mark Read</a>
                            <?php endif; ?>
                            <a class="action-delete" href="delete.php?type=contact&id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this message?');">🗑 Delete</a>
                        </div>
                    </td>
                </tr>
            <?php endwhile; ?>
    ...
    <div class="admin-actions admin-actions--center">
        ...
        <a class="admin-btn" href="delete.php?type=mark_all_read_contact" onclick="return confirm('Mark ALL contact messages as read?');">✅ Mark All as Read</a>
    </div>
